...
# DESCRIPTION:    Cloud Assistants arucoid management
# TO_BUILD:       cafjs mkImage . gcr.io/cafjs-k8/root-arucoid
# TO_RUN:         cafjs run --appImage gcr.io/cafjs-k8/root-arucoid arucoid
